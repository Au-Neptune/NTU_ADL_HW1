...
def parse_args():
    ...
    parser.add_argument("--do_train", action="store_true", help="To do prediction on the question answering model")
    parser.add_argument(
    ...
    parser.add_argument("--do_eval", action="store_true", help="To do prediction on the question answering model")
    parser.add_argument(
...
def main():
    ...
    column_names = raw_datasets["train"].column_names if "train" in raw_datasets else raw_datasets["test"].column_names
